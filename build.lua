...
common.build_rom_and_handle_failure("main", "s2built", "", "-p=FF -z=0," .. compression .. ",Size_of_DAC_driver_guess,after", false, "https://github.com/sonicretro/s1disasm")
...
os.execute(extra_tools.convsym .. " main.lst s2built.bin -input as_lst -range 0 FFFFFF -a")
os.execute(extra_tools.convsym .. " main.lst s2built.debug.bin -input as_lst -exclude -filter \"z[A-Z].+\" -range 0 FFFFFF -a")
end
