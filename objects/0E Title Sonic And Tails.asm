...
TSon_Main:	; Routine 0
		...
		move.w	#$C4,obScreenX(a0) ; position is fixed to screen
...
TSon_Move:	; Routine 4
		subq.w	#8,obScreenX(a0) ; move Sonic up
		cmpi.w	#$96,obScreenX(a0) ; has Sonic reached final position?
