...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_obj42,	id_Obj42,	0,	0,	make_art_tile(ArtTile_Newtron,0,0)
	dbug	Map_obj42,	id_Obj42,	1,	0,	make_art_tile(ArtTile_Newtron,1,0)
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Obj03,	id_Obj03,	0,	0,	make_art_tile(ArtTile_Ring,1,0)
	;dbug	Map_Redz,	id_Obj4F,	0,	0,	make_art_tile(ArtTile_Redz,0,0)
